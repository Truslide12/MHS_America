<?php /* Smarty version 2.6.26, created on 2013-11-11 02:49:03
...
" type="radio" <?php if ($this->_tpl_vars['currentProviderId'] == $this->_tpl_vars['id']): ?>checked="checked"<?php endif; ?>
                           id="provider_input_<?php echo $this->_tpl_vars['id']; ?>
...
:
                            <div style="text-align:left;">
                                ...
                                <span class='loadingPiwik' style='display:none;position:absolute'><img
                                            src='./themes/default/images/loading-blue.gif'/> <?php echo ((is_array($_tmp='General_Loading_js')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</span>
...
..." id="start-automatic-update-geoip"/>
        ...
        <?php echo ((is_array($_tmp='UserCountry_DownloadingDb')) ? $this->_run_mod_handler('translate', true, $_tmp, "<a href=\"".($this->_tpl_vars['geoLiteUrl'])."\">GeoLiteCity.dat</a>") : smarty_modifier_translate($_tmp, "<a href=\"".($this->_tpl_vars['geoLiteUrl'])."\">GeoLiteCity.dat</a>")); ?>
...</p>
