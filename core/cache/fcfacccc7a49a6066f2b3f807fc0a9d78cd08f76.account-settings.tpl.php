...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_529a74b0177277_70666210',
  'cache_lifetime' => 20,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_529a74b0177277_70666210')) {function content_529a74b0177277_70666210($_smarty_tpl) {?><!DOCTYPE html>
		...
		<nav>
			<ul>
				<li id="page-direction">Select your state from the map below:</li>
								...
								<li class="right"><a class="dashie" href="/account"><span class="r"><img src="http://www.gravatar.com/avatar/a96c66dce841ac8fbff4606f4fed0c10?s=32&d=mm"></span><span style="line-height:2.5;padding:0 1em 0 0;">Paul1</span></a>
				<div class="drop">
					<div class="account-box">
						<span class="r"><img src="http://www.gravatar.com/avatar/a96c66dce841ac8fbff4606f4fed0c10?s=32&d=mm"></span>
						<h2><strong><span>Paul1</span></strong></h2>
...
"></a>
		<?php }else{ ?><h1><a href="/account">Dashboard</a> &raquo; Settings</h1>
...
!</h2><?php }?>
		<div class="dashboard-box" id="settings-form">
			...
			<section>
					...
					<h3>Your username</h3>
					<div class="pp">
						<label>Username<br><input type="text" class="textbox" disabled="disabled" value="paul1" style="background:#efefef;cursor:default;"></label>
					</div>
					<hr>
					<h3>Change associated email</h3>
					<div class="pp">
						<label for="set_email">Email address<br><input type="text"  name="email" id="set_email" value="paul@mhsamerica.com" class="textbox"></label>
					</div>
					<hr>
					...
					<div class="pp">
						...
						<img src="http://www.gravatar.com/avatar/a96c66dce841ac8fbff4606f4fed0c10?s=175&d=mm" alt="avatar">
					</div>
					<hr>
		...
		<div class="wrapper">
			<div class="grid">
				...
				<div class="g4">
					...
					<div class="account-box">
						<span style="float:right;margin:-0.4em;"><img src="http://gravatar.com/avatar/a96c66dce841ac8fbff4606f4fed0c10?s=40&d=mm"></span>
						<strong>Logged in as <span>Paul1</span></strong><br/>
...
<script type="text/javascript"> 
  ...
  _paq.push(['setCustomVariable',1,"Username","paul1","visit"]);  _paq.push(['trackPageView']);
