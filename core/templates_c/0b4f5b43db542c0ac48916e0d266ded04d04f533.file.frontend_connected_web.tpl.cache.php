<?php /* Smarty version Smarty-3.1.8, created on 2013-12-03 21:22:12
         compiled from "./incl/xhtml/default/frontend_connected_web.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_529e9fe4be1e91_09198529',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_529e9fe4be1e91_09198529')) {function content_529e9fe4be1e91_09198529($_smarty_tpl) {?><!DOCTYPE html>
...
">
	...
	<script src="/_/js/<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'jquery\']){?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'jquery\'];?>
/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }else{ ?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
jquery-1.10.2.min.js<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
"></script>
...
&d=mm"></span>
						...
						<ul class="action-list">
							...
							<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'useritems\']){?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>

							<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php  $_smarty_tpl->tpl_vars[\'opt\'] = new Smarty_Variable; $_smarty_tpl->tpl_vars[\'opt\']->_loop = false;
...
?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
							...
							<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php if ($_smarty_tpl->tpl_vars[\'opt\']->value[0]==\'separator\'){?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<li><hr></li><?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }elseif($_smarty_tpl->tpl_vars[\'opt\']->value[0]==\'title\'){?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<li><strong><?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php echo $_smarty_tpl->tpl_vars[\'opt\']->value[1];?>
/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
</strong></li><?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }else{ ?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<li><a href="<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php echo $_smarty_tpl->tpl_vars[\'opt\']->value[0];?>
/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
"><?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php echo $_smarty_tpl->tpl_vars[\'opt\']->value[1];?>
/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
</a></li><?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>

							<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php } ?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
...
/account/register" class="zocial secondary r">New Account</a> <a href="#" class="zocial primary" onclick="$('#loginSubmit').click();">Login</a><input type="submit" id="loginSubmit" style="display:none;" value="Login">
	...
	<div id="submenu"></div>
	<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\']){?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<style type="text/css">
		div#submenu { border-color:#545454; }
	</style><img src="/_/images/backdrops/<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'file\'];?>
/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
" alt="" id="pagecanvas"<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'heightstretch\']==1){?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
 style="height:100%;width:auto;max-width:none;min-width:100%;"<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
><?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>

<?php if ((p('advert'))==true){?><aside class="advertisement" id="backdrop"><a href="<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'backdrop\'][\'url\'];?>
/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
"><img src="<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'backdrop\'][\'image\'];?>
/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
"/></a><?php }?></div>
<div id="content">
<?php if ((p('advert'))==true){?><span class="ad-notice<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'blacknotices\']==1){?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
 black<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
" id="advertisement-notice-right">Sponsored Ad</span><span class="ad-notice<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'blacknotices\']==1){?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
 black<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
...
connected">Connected</a></li>
				...
				<div class="g3"><hr><h3>&middot; &middot; &middot;</h3><p><small><?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'credit\']){?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<span style="font-style:italic;">Background image by <?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\']&&!$_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'courtesy\']){?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<a href="<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\'];?>
/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
" target="_blank" rel="noindex,nofollow"><?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'credit\'];?>
/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\']&&!$_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'courtesy\']){?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
</a><?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'courtesy\']){?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<br>Courtesy of <?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\']){?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<a href="<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\'];?>
/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
" target="_blank" rel="noindex,nofollow"><?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'courtesy\'];?>
/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\']){?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
</a><?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
.</span><br><?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
...
<?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'pragpage\']=="state"){?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
<script type="text/javascript">
$(document).ready(function(){
...
</script><?php echo '/*%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/<?php }?>/*/%%SmartyNocache:1796721254529e9fe420e840-02858129%%*/';?>
