<?php /* Smarty version Smarty-3.1.8, created on 2013-10-21 22:56:44
         compiled from "./incl/xhtml/frontend_plans.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18646044945265f77ccd1ba3-90591315%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8636ce71137982da2e00711df9a6c062f16ace58' => 
    array (
      0 => './incl/xhtml/frontend_plans.tpl',
      1 => 1382405586,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '18646044945265f77ccd1ba3-90591315',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5265f77d312a90_19600037',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5265f77d312a90_19600037')) {function content_5265f77d312a90_19600037($_smarty_tpl) {?><!DOCTYPE html>
...
?><div<?php if ($_smarty_tpl->tpl_vars['plan']->value['id']==$_smarty_tpl->tpl_vars['page']->value['featured_plan']){?> class="current"<?php }elseif($_smarty_tpl->tpl_vars['plan']->value['id']>$_smarty_tpl->tpl_vars['page']->value['featured_plan']){?> class="after<?php if ($_smarty_tpl->tpl_vars['plan']->value['id']==$_smarty_tpl->tpl_vars['page']->value['featured_plan']+1){?> rightafter<?php }?>"<?php }?>>
...
?>
					...
					<p class="switchbtn"><a class="zocial <?php if ($_smarty_tpl->tpl_vars['plan']->value['name']=='free'){?>secondary<?php }else{ ?>primary<?php }?>" href="/account/register/profile?plan=<?php echo $_smarty_tpl->tpl_vars['plan']->value['id'];?>
