...
<div class="row white mb-0" id="loginform" style="padding: 10px 0px;">
	<div class="col-md-6 col-md-offset-1">
		<p>
		Feature your community on the leading site for manufactured housing.
		</p>
		@if(!$errors->count() > 0)
		<button class="btn btn-success btn-lg" onclick="create()">Create Account</button>
		@endif
	</div>
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label for="inputPassword3" class="control-label">
                    Password</label>
                <div class="">
                    <input type="password" class="form-control" name="password" id="inputPassword3" @if($has_account) value="wizard" @endif placeholder="Password"  required>
                </div>
            </div>
            <div class="form-group">
                <div class="">
            ...
            <div class="form-group last">
                <div class="col-sm-offset-3 col-sm-9">
					<button type="submit" class="btn btn-primary cta btn-sm">Sign in</button>
...
<div class="row white mb-0" id="createform" style="padding: 10px 0px;@if(!$has_account && !$errors->count() > 0)display: none;@endif">
	<form class="form-horizontal row" id="setupform" action="" method="post">
	{{ csrf_field() }}
	<div class="col-md-10 col-md-offset-1">
		...
		<div class="formhead">Account Information</div>
		  ...
		  <div class="form-group  col-md-6">
		    ...
		    <div class="col-sm-9">
		      <select class="form-control" id="personal-city" name="personal-city" readonly>
...
<div id="iam" style="display: none;">
		  ...
		  <div class="form-group  col-md-6">
		    ...
		    <div class="col-sm-9">
		      <input type="text" class="form-control" id="business-phone" name="business-phone" value="{{ Input::get('business-phone') }}" placeholder="">
		    </div>
		  </div>
		  <div class="form-group  col-md-6">
		    <label for="" class="col-sm-3 control-label">Fax</label>
		    <div class="col-sm-9">
		      <input type="text" class="form-control" id="business-fax" name="business-fax" value="{{ Input::get('business-fax') }}" placeholder="">
		    </div>
		  </div>
		  <div class="form-group  col-md-6">
		    <label for="" class="col-sm-3 control-label"><span class="req_field">*</span>Address 1</label>
		    <div class="col-sm-9">
		      <input type="text" class="form-control" id="business-address-1" name="business-address-1" value="{{ Input::get('business-address-1') }}" placeholder="">
		    </div>
		  </div>
		  <div class="form-group  col-md-6">
		    <label for="" class="col-sm-3 control-label">Address 2</label>
		    <div class="col-sm-9">
		      <input type="text" class="form-control" id="business-address-2" name="business-address-2" value="{{ Input::get('business-address-2') }}" placeholder="">
		    </div>
		  </div>
		  <div class="form-group  col-md-6">
		    <label for="" class="col-sm-3 control-label"><span class="req_field">*</span>State</label>
		  ...
		  <div class="form-group  col-md-6">
		    <label for="" class="col-sm-3 control-label"><span class="req_field">*</span>Zip</label>
		    <div class="col-sm-9">
		      <input type="text" class="form-control" id="business-zip" name="business-zip" value="{{ Input::get('business-zip') }}" placeholder="">
		    </div>
		  </div>
		</div>
		  ...
		  <div class="form-group  col-md-12" style="display: flex!important;align-content: center;align-items: center;justify-content: center;background:none;padding: 10px 0px;margin-top: 125px;">
		  	<div class="col-md-5 col-sm-offset-1" style="">
		  		<div class="" style="background: none;margin: auto auto;margin-bottom: 10px;">
                	<input type="checkbox" name="agree-auth" id="agree-auth" value="1"> 
                	<span id="auth_text">I am Authorized to Create this Company</span>
                </div>
		  		<div class="" style="background: none;margin: auto auto;">
                	<input type="checkbox" name="agree-terms" id="agree-terms" value="1"> 
