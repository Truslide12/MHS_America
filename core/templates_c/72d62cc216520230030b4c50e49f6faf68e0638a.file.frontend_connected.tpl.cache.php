<?php /* Smarty version Smarty-3.1.8, created on 2013-12-06 13:44:37
         compiled from "./incl/xhtml/default/frontend_connected.tpl" */ ?>
<?php /*%%SmartyHeaderCode:214070290152a229251215e2-27566452%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '72d62cc216520230030b4c50e49f6faf68e0638a' => 
    array (
      0 => './incl/xhtml/default/frontend_connected.tpl',
      1 => 1383630391,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '214070290152a229251215e2-27566452',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52a22925c9b6d5_26220362',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52a22925c9b6d5_26220362')) {function content_52a22925c9b6d5_26220362($_smarty_tpl) {?><!DOCTYPE html>
...
">
	...
	<script src="/_/js/<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'jquery\']){?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'jquery\'];?>
/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }else{ ?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
jquery-1.10.2.min.js<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
"></script>
...
&d=mm"></span>
						...
						<ul class="action-list">
							...
							<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'useritems\']){?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>

							<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php  $_smarty_tpl->tpl_vars[\'opt\'] = new Smarty_Variable; $_smarty_tpl->tpl_vars[\'opt\']->_loop = false;
...
?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
							...
							<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php if ($_smarty_tpl->tpl_vars[\'opt\']->value[0]==\'separator\'){?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<li><hr></li><?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }elseif($_smarty_tpl->tpl_vars[\'opt\']->value[0]==\'title\'){?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<li><strong><?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php echo $_smarty_tpl->tpl_vars[\'opt\']->value[1];?>
/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
</strong></li><?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }else{ ?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<li><a href="<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php echo $_smarty_tpl->tpl_vars[\'opt\']->value[0];?>
/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
"><?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php echo $_smarty_tpl->tpl_vars[\'opt\']->value[1];?>
/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
</a></li><?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>

							<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php } ?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
...
/account/register" class="zocial secondary r">New Account</a> <a href="#" class="zocial primary" onclick="$('#loginSubmit').click();">Login</a><input type="submit" id="loginSubmit" style="display:none;" value="Login">
	...
	<div id="submenu"></div>
	<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\']){?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<style type="text/css">
		div#submenu { border-color:#545454; }
	</style><img src="/_/images/backdrops/<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'file\'];?>
/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
" alt="" id="pagecanvas"<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'heightstretch\']==1){?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
 style="height:100%;width:auto;max-width:none;min-width:100%;"<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
><?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>

<?php if ((p('advert'))==true){?><aside class="advertisement" id="backdrop"><a href="<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'backdrop\'][\'url\'];?>
/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
"><img src="<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'backdrop\'][\'image\'];?>
/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
"/></a><?php }?></div>
<div id="content">
<?php if ((p('advert'))==true){?><span class="ad-notice<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'blacknotices\']==1){?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
 black<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
" id="advertisement-notice-right">Sponsored Ad</span><span class="ad-notice<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'blacknotices\']==1){?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
 black<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
...
connected">Connected</a></li>
				...
				<div class="g3"><hr><h3>&middot; &middot; &middot;</h3><p><small><?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'credit\']){?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<span style="font-style:italic;">Background image by <?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\']&&!$_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'courtesy\']){?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<a href="<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\'];?>
/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
" target="_blank" rel="noindex,nofollow"><?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'credit\'];?>
/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\']&&!$_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'courtesy\']){?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
</a><?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'courtesy\']){?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<br>Courtesy of <?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\']){?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<a href="<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\'];?>
/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
" target="_blank" rel="noindex,nofollow"><?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'courtesy\'];?>
/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\']){?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
</a><?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
.</span><br><?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
...
<?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'pragpage\']=="state"){?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
<script type="text/javascript">
$(document).ready(function(){
...
</script><?php echo '/*%%SmartyNocache:214070290152a229251215e2-27566452%%*/<?php }?>/*/%%SmartyNocache:214070290152a229251215e2-27566452%%*/';?>
