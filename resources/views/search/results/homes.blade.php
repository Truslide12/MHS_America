...
<div class="row white">
				...
				<div class="panel panel-default text-center">
					<div class="panel-body">
						...
						<h4 class="text-open">
							...
							{{ $error }}
							@else
							No matching homes were found<br> within {{ $radius }} miles of {{ $centroid->place_name.', '.$centroid->state_name }}.
							@endif
							<br>
	...
	@else
		@if(1==2){{ $homes->appends($pagination_params)->links() }}@endif
		@foreach($homes as $home)
		@include('layouts.partial.home-block')
		@endforeach
		@if(1==2){{ $homes->links() }}@endif
	@endif
	</div>
</div>
@stop