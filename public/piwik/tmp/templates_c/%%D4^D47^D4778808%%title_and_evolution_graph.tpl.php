...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'Goals/templates/title_and_evolution_graph.tpl', 4, false),array('modifier', 'money', 'Goals/templates/title_and_evolution_graph.tpl', 22, false),array('function', 'sparkline', 'Goals/templates/title_and_evolution_graph.tpl', 9, false),)), $this); ?>
...
<div id='leftcolumn' <?php if (! $this->_tpl_vars['isWidget']): ?>style='width:33%'<?php endif; ?>>
    <div class="sparkline"><?php echo smarty_function_sparkline(array('src' => $this->_tpl_vars['urlSparklineConversions']), $this);?>
        ...
        <?php if (isset ( $this->_tpl_vars['ecommerce'] )): ?>
            <strong><?php echo $this->_tpl_vars['nb_conversions']; ?>
</strong>
            <?php echo ((is_array($_tmp='General_EcommerceOrders')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
