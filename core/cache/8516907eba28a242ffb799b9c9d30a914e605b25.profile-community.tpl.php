...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52cdb87906aed0_28455866',
  'cache_lifetime' => 900,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52cdb87906aed0_28455866')) {function content_52cdb87906aed0_28455866($_smarty_tpl) {?><!DOCTYPE html>
...
<div class="county-content">
	<div itemprop="about" itemscope itemtype="http://schema.org/LocalBusiness" class="content-box profile"><link itemprop="additionalType" href="http://schema.org/MobileHomeCommunity"><?php if ($_smarty_tpl->tpl_vars['page']->value['editmode']){?><form action="<?php echo s('domain');?>
...
"> /mo</label>
				...
				<?php if ($_smarty_tpl->tpl_vars['page']->value['data']['senior']==1){?><div class="info-tile fiftyfive dbl-tile">Senior</div><?php }else{ ?><div class="info-tile fiftyfive dbl-tile">Family</div><?php }?>
...
<?php }?>
		...
		<?php if ($_smarty_tpl->tpl_vars['page']->value['company']['name']){?><div style="text-align:center;margin:1em 0;"><?php if ($_smarty_tpl->tpl_vars['page']->value['company']['data']['logo_emblem']){?><img src="<?php echo $_smarty_tpl->tpl_vars['page']->value['company']['data']['logo_emblem'];?>
"><?php }else{ ?>A <?php echo $_smarty_tpl->tpl_vars['page']->value['company']['title'];?>
 Community<?php }?></div><?php }?>
	</div>
</div>
</section>
