...
<!-- Start Mission and Goals section -->
	<div class="row clearfix nudge white mission-and-goals-section">
		<div class="col-md-12">
			<h2>Our Mission &amp; Goals</h2>
			<div class="" id="goalsbox">
				<div class="col-md-4">
					<img src="{{ URL::route('welcome') }}/img/stockphotos/couple-home-house-1288482-web.jpg" class="goal-imgs">
				...
				<div class="col-md-4">
					<img src="{{ URL::route('welcome') }}/img/stockphotos/accomplishment-agreement-business-1249158-web.jpg" class="goal-imgs">
				...
				<div class="col-md-4">
					<img src="{{ URL::route('welcome') }}/img/stockphotos/achievement-agreement-arms-1068523-web.jpg" class="goal-imgs">
