...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52a3b4ea177ee2_89321156',
  'cache_lifetime' => 20,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52a3b4ea177ee2_89321156')) {function content_52a3b4ea177ee2_89321156($_smarty_tpl) {?><!DOCTYPE html>
...
<section id="business-wizard"><?php if ($_smarty_tpl->tpl_vars['page']->value['action']=="new"){?><form method="post" action="/order/payment">
...
" width="228" height="80" alt=""></div><?php }?>
			<footer><a class="zocial secondary" href="/order/payment?pid=<?php echo $_smarty_tpl->tpl_vars['prof']->value['id'];?>
