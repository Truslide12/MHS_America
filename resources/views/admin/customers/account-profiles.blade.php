	...
	<div class="col-md-12">
			...
			<thead>
				...
				<tr>
					<th colspan="4" style="display: flex;">
						...
						<a href="?view=profiles" style="margin:auto;width: 20%;" class="btn btn-success" disabled>Profiles</a>
		...
		<table class="table table-bordered table-hover table-striped dataTable" style="border-top:0;font-size: 1.5em;">
			...
			<tbody>
				...
				<tr>
					<td width="75%" colspan="3">{{$profile->title}}</td>
					<td width="25%" style="text-align: center;"><a href="/profile/{{$profile->id}}" target="_blank">View</a> | <a href="/profile/{{$profile->id}}/edit" target="_blank">Edit</a></td>
				</tr>
				@endforeach
				@else
				<tr>
