<?php /* Smarty version Smarty-3.1.8, created on 2013-12-17 14:21:16
         compiled from "./incl/xhtml/default/frontend/frontend_enterprise.tpl" */ ?>
<?php /*%%SmartyHeaderCode:89238470752b0b23c4cd091-24742994%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4c43544975047e3473bc44614e41acf1ef9143d0' => 
    array (
      0 => './incl/xhtml/default/frontend/frontend_enterprise.tpl',
      1 => 1387311381,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '89238470752b0b23c4cd091-24742994',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52b0b23ceea123_10418994',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52b0b23ceea123_10418994')) {function content_52b0b23ceea123_10418994($_smarty_tpl) {?><!DOCTYPE html>
...
">
	...
	<script src="/_/js/<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'jquery\']){?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'jquery\'];?>
/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }else{ ?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
jquery-1.10.2.min.js<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
"></script>
...
&d=mm"></span>
						...
						<ul class="action-list">
							...
							<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'useritems\']){?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>

							<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php  $_smarty_tpl->tpl_vars[\'opt\'] = new Smarty_Variable; $_smarty_tpl->tpl_vars[\'opt\']->_loop = false;
...
?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
							...
							<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php if ($_smarty_tpl->tpl_vars[\'opt\']->value[0]==\'separator\'){?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<li><hr></li><?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }elseif($_smarty_tpl->tpl_vars[\'opt\']->value[0]==\'title\'){?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<li><strong><?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php echo $_smarty_tpl->tpl_vars[\'opt\']->value[1];?>
/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
</strong></li><?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }else{ ?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<li><a href="<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php echo $_smarty_tpl->tpl_vars[\'opt\']->value[0];?>
/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
"><?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php echo $_smarty_tpl->tpl_vars[\'opt\']->value[1];?>
/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
</a></li><?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>

							<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php } ?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
...
/account/register" class="zocial secondary r">New Account</a> <a href="#" class="zocial primary" onclick="$('#loginSubmit').click();">Login</a><input type="submit" id="loginSubmit" style="display:none;" value="Login">
	...
	<div id="submenu"></div>
	<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\']){?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<style type="text/css">
		div#submenu { border-color:#545454; }
	</style><img src="/_/images/backdrops/<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'file\'];?>
/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
" alt="" id="pagecanvas"<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'heightstretch\']==1){?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
 style="height:100%;width:auto;max-width:none;min-width:100%;"<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
><?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>

<?php if ((p('advert'))==true){?><aside class="advertisement" id="backdrop"><a href="<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'backdrop\'][\'url\'];?>
/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
"><img src="<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'backdrop\'][\'image\'];?>
/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
"/></a><?php }?></div>
<div id="content">
<?php if ((p('advert'))==true){?><span class="ad-notice<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'blacknotices\']==1){?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
 black<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
" id="advertisement-notice-right">Sponsored Ad</span><span class="ad-notice<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'blacknotices\']==1){?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
 black<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
...
connected">Connected</a></li>
				...
				<div class="g3"><hr><h3>&middot; &middot; &middot;</h3><p><small><?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'credit\']){?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<span style="font-style:italic;">Background image by <?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\']&&!$_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'courtesy\']){?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<a href="<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\'];?>
/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
" target="_blank" rel="noindex,nofollow"><?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'credit\'];?>
/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\']&&!$_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'courtesy\']){?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
</a><?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'courtesy\']){?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<br>Courtesy of <?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\']){?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<a href="<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\'];?>
/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
" target="_blank" rel="noindex,nofollow"><?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php echo $_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'courtesy\'];?>
/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'canvas\'][\'link\']){?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
</a><?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
.</span><br><?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
...
<?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php if ($_smarty_tpl->tpl_vars[\'page\']->value[\'pragpage\']=="state"){?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
<script type="text/javascript">
$(document).ready(function(){
...
</script><?php echo '/*%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/<?php }?>/*/%%SmartyNocache:89238470752b0b23c4cd091-24742994%%*/';?>
