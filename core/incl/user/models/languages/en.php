...
$lang = array_merge($lang,array(
	"ACCOUNT_SPECIFY_USERNAME_AND_PASSWORD" 		=> "Please enter your username and password",
	...
	"ACCOUNT_NOT_ALLOWED"			=> "You are not an authorized user.<br>If this is in error, please contact the administrator."
	));
...
//Miscellaneous
$lang = array_merge($lang,array(
	"CAPTCHA_FAIL"				=> "Please re-enter the code and whatever info has blanked out.",
	"CONFIRM"				=> "Confirm",
	"DENY"					=> "Deny",
	"SUCCESS"				=> "Success",
	"ERROR"					=> "Error",
