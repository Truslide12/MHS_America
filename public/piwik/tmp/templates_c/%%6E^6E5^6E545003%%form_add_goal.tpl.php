<?php /* Smarty version 2.6.26, created on 2013-12-09 04:00:48
         compiled from Goals/templates/form_add_goal.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'Goals/templates/form_add_goal.tpl', 6, false),array('modifier', 'money', 'Goals/templates/form_add_goal.tpl', 86, false),)), $this); ?>
<div class='entityAddContainer' style="display:none;">
    <form>
        <table class="dataTable entityTable">
            <thead>
            <tr class="first">
                <th colspan="2"><?php echo ((is_array($_tmp='Goals_AddNewGoal')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</th>
            <tr>
            </thead>
            <tbody>
            ...
            <tr>
                <td style='width:260px;' class="first"><?php echo ((is_array($_tmp='Goals_GoalIsTriggered')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
 ...
 <input type="checkbox" id="case_sensitive"/>
            ...
            <tbody>
            <tr>
                <td class="first"><?php echo ((is_array($_tmp='Goals_Optional')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
 <?php echo ((is_array($_tmp='Goals_DefaultRevenue')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</td>
