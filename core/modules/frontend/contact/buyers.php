...
<img src="/managerialitiness/inc/uploads/homes/<?php echo $home['id'] ?>/<?php echo $home['defaultpic'] ?>" width="100%" style="border:2px solid #000000;border-radius:6px;-moz-border-radius:6px;-webkit-border-radius:6px;"/><br/><h2><?php echo($l['homeinquestion']); ?></h2>
</div>
<?php } ?>
<div id="contactform" class="contblock lefty" width="75%"><h1 style="font-size:180%;"><?php echo $l['homeinquiry']; ?></h1>
<br class="clr"/>
