...
$mail_templates_dir = "incl/user/models/mail-templates/";
$websiteName = $settings['website_name']['value'];
if(defined('IS_ADMINCP')) {
	$websiteUrl = "luna.mhsamerica.com/";
}else{
...
if (!file_exists($language)) {
	$language = "./incl/user/models/languages/en.php";
}

if(!isset($language)) $language = "./incl/user/models/languages/en.php";
